...
namespace Finances2
{
    ...
    public class Data
    {
        public List<Combined> combined { get; set; }
    }
    */
    ...
    public class Data2
    {
        public List<Combined2> combined { get; set; }
    }
    ...
    */
    ...
    public class Data3
    {
        public List<Combined3> combined { get; set; }
    }
    */
    ...
    public class Data4
    {
        public List<Combined4> combined { get; set; }
    }
    ...
    public class RootObject
    {
        ...
        public string lexicon_name { get; set; }
        public string name { get; set; }
        public int rounding_unit { get; set; }
